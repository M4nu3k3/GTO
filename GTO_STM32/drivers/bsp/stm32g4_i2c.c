...
void HAL_I2C_MspInit(I2C_HandleTypeDef* i2cHandle)
{
  ...
  /* Initializes the peripherals clocks */
    ...
    PB7     ------> I2C1_SDA
    */
    BSP_GPIO_pin_config(GPIOA, GPIO_PIN_15, GPIO_MODE_AF_OD, GPIO_NOPULL, GPIO_SPEED_FREQ_LOW, GPIO_AF4_I2C1);
    BSP_GPIO_pin_config(GPIOB, GPIO_PIN_7, GPIO_MODE_AF_OD, GPIO_NOPULL, GPIO_SPEED_FREQ_LOW, GPIO_AF4_I2C1);
  ...
  /* Initializes the peripherals clocks */
    ...
    PA9     ------> I2C2_SCL
    */
    BSP_GPIO_pin_config(GPIOF, GPIO_PIN_0, GPIO_MODE_AF_OD, GPIO_NOPULL, GPIO_SPEED_FREQ_LOW, GPIO_AF4_I2C2);
    BSP_GPIO_pin_config(GPIOA, GPIO_PIN_9, GPIO_MODE_AF_OD, GPIO_NOPULL, GPIO_SPEED_FREQ_LOW, GPIO_AF4_I2C2);
  ...
  /* Initializes the peripherals clocks */
    ...
    PB5     ------> I2C3_SDA
    */
    BSP_GPIO_pin_config(GPIOA, GPIO_PIN_8, GPIO_MODE_AF_OD, GPIO_NOPULL, GPIO_SPEED_FREQ_LOW, GPIO_AF2_I2C3);
    BSP_GPIO_pin_config(GPIOB, GPIO_PIN_5, GPIO_MODE_AF_OD, GPIO_NOPULL, GPIO_SPEED_FREQ_LOW, GPIO_AF8_I2C3);
